...
let firstLastName = (entrepreneurs_arr) => {
  let arr = []
  for (let entrepreneur of entrepreneurs_arr) {
    arr.push({ first: entrepreneur.first, last: entrepreneur.last })
  }
  return arr
}
...
let age = (entrepreneurs_arr) => {
  ...
  let arr = []
  for (let entrepreneur of entrepreneurs_arr) {
    arr.push({ first: entrepreneur.first, last: entrepreneur.last, age: (2021 - entrepreneur.year) })
  }
  return arr
}
...
let rename = (entrepreneurs_arr) => {
  ...
  let arr = []
  for (let entrepreneur of entrepreneurs_arr) {
    arr.push({ firstName: entrepreneur.first, lastName: entrepreneur.last, age: (2021 - entrepreneur.year) })
  }
  return arr
}
